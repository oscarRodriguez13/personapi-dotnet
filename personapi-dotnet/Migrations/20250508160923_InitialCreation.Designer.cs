...
namespace personapi_dotnet.Migrations
{
    ...
    [Migration("20250508160923_InitialCreation")]
            ...
            modelBuilder.Entity("personapi_dotnet.Models.Entities.Estudio", b =>
                {
                    ...
                    b.HasKey("IdProf", "CcPer")
                        .HasName("PK__estudios__FB3F71A6B8574F61");
            ...
            modelBuilder.Entity("personapi_dotnet.Models.Entities.Persona", b =>
                {
                    ...
                    b.HasKey("Cc")
                        .HasName("PK__persona__3213666D564B0149");
            ...
            modelBuilder.Entity("personapi_dotnet.Models.Entities.Profesion", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("PK__profesio__3213E83F2B1F13F8");
            ...
            modelBuilder.Entity("personapi_dotnet.Models.Entities.Telefono", b =>
                {
                    ...
                    b.HasKey("Num")
                        .HasName("PK__telefono__DF908D659694C3B2");
            ...
            modelBuilder.Entity("personapi_dotnet.Models.Entities.Estudio", b =>
                {
                    ...
                    b.HasOne("personapi_dotnet.Models.Entities.Persona", "Persona")
                        .WithMany()
                        .HasForeignKey("PersonaCc")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("personapi_dotnet.Models.Entities.Profesion", "Profesion")
                        .WithMany()
